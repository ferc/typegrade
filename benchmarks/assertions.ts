...
export const PAIRWISE_ASSERTIONS: PairwiseAssertion[] = [
  ...
  { class: "must-pass", composite: "consumerApi", higher: "zod", introducedAt: "v0.4.0", lower: "lodash", minDelta: 3, reason: "Branded output types and discriminated unions vs utility with broad @types definitions" },
  { class: "must-pass", composite: "consumerApi", higher: "valibot", introducedAt: "v0.4.0", lower: "express", minDelta: 3, reason: "Tree-shakeable validation with narrow types vs loosely-typed middleware" },
  { class: "must-pass", composite: "consumerApi", higher: "valibot", introducedAt: "v0.4.0", lower: "lodash", minDelta: 3, reason: "Tree-shakeable validation with narrow types vs utility with broad @types definitions" },
  { class: "must-pass", composite: "consumerApi", higher: "ts-pattern", introducedAt: "v0.4.0", lower: "express", minDelta: 3, reason: "Exhaustive pattern matching with discriminated unions vs loosely-typed middleware" },
  { class: "must-pass", composite: "consumerApi", higher: "date-fns", introducedAt: "v0.4.0", lower: "lodash", minDelta: 3, reason: "Well-typed date utilities with overloaded signatures vs broad @types definitions" },
  { class: "must-pass", composite: "consumerApi", higher: "arktype", introducedAt: "v0.4.0", lower: "express", minDelta: 3, reason: "Elite validation with deep type inference vs loosely-typed middleware" },
  { class: "must-pass", composite: "consumerApi", higher: "arktype", introducedAt: "v0.4.0", lower: "lodash", minDelta: 3, reason: "Elite validation with branded/constrained types vs broad @types definitions" },
  { class: "must-pass", composite: "consumerApi", higher: "effect", introducedAt: "v0.4.0", lower: "express", minDelta: 3, reason: "Effect system with branded/tagged types vs loosely-typed middleware" },
  { class: "must-pass", composite: "consumerApi", higher: "effect", introducedAt: "v0.4.0", lower: "lodash", minDelta: 3, reason: "Effect system with branded/tagged types vs broad @types definitions" },
  ...
  { class: "must-pass", composite: "consumerApi", higher: "arktype", introducedAt: "v0.4.0", lower: "axios", minDelta: 5, reason: "Elite validation library vs loosely-typed HTTP client" },
  { class: "must-pass", composite: "consumerApi", higher: "effect", introducedAt: "v0.4.0", lower: "axios", minDelta: 5, reason: "Elite effect system vs loosely-typed HTTP client" },
  ...
  { class: "must-pass", composite: "consumerApi", higher: "remeda", introducedAt: "v0.4.0", lower: "express", minDelta: 3, reason: "Typed functional utility vs loosely-typed middleware" },
  { class: "must-pass", composite: "consumerApi", higher: "neverthrow", introducedAt: "v0.4.0", lower: "moment", minDelta: 2, reason: "Result monad with discriminated types vs legacy date library" },
  { class: "must-pass", composite: "consumerApi", higher: "type-fest", introducedAt: "v0.4.0", lower: "axios", minDelta: 3, reason: "Advanced type utilities vs loosely-typed HTTP client" },
  { class: "must-pass", composite: "consumerApi", higher: "date-fns", introducedAt: "v0.4.0", lower: "uuid", minDelta: 3, reason: "Well-typed date utilities with overloaded signatures vs simple UUID generator" },
